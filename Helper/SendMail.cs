    ...
    public class SendMail
    {
        ...
        private void CreateFile(DateTime start, DateTime end)
        {
            ...
            var tags = new List<string>() {
                ...
                "[FPC_1]VFD3D_KW_FB","[FPC_1]HV-2_KWH_FB","[FPC_1]HV-3_KWH_FB","[FPC_1]HV-6_KWH_FB","[FPC_1]HV-7_KWH_FB", "Power1.Power.Power", "Power2.Power.Power", "[FPC_1]RW_FIT"
            };
            ...
            var tagHeaders = new List<string>()  {
                ...
                "[FPC_1]VFD1_SPD_FB", "[FPC_1]VFD2_SPD_FB", "[FPC_1]VFD3C_SPD_FB", "[FPC_1]VFD3D_SPD_FB",
                "[FPC_1]VFD1_KW_FB", "[FPC_1]VFD2_KW_FB", "[FPC_1]VFD3C_KW_FB",
                "[FPC_1]VFD3D_KW_FB","[FPC_1]HV-2_KWH_FB","[FPC_1]HV-3_KWH_FB","[FPC_1]HV-6_KWH_FB","[FPC_1]HV-7_KWH_FB" , "LV-Multimeter 1", "LV-Multimeter 2", "[FPC_1]RW_FIT"
            };
